...
import com.example.imageclassification.ml.Meumodeloquantizado
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val labels = application.assets.open("labelsm.txt").bufferedReader().use { it.readText() }.split("\n")
        ...
        make_prediction.setOnClickListener(View.OnClickListener {
            ...
            val model = Meumodeloquantizado.newInstance(this)
